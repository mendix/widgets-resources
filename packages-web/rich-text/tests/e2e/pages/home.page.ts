class HomePage {
    public get richTextBubbleBasic() { return browser.element(".mx-name-rich_text_bubble_basic .ql-editor"); }
    ...
    public get textAreaBubbleBasic() { return browser.element(".mx-name-text_area_bubble_basic .mx-textarea-input"); }
