var contentGroup = `<?xml version="1.0" encoding="utf-8"?>
    ...
    <properties>
        <propertyGroup caption="General">
            <propertyGroup caption="Values">
                ...
                <property key="valueExpressionList" type="expression" required="false">
                    <caption>Expression list value</caption>
                    <description/>
                    <returnType type="Decimal" isList="true"/>
                </property>
            </propertyGroup>
...
module.exports = {contentGroup, content};
