...
export default args => {
    ...
    // We change the output because PieChart widget package was wrongly named with uppercase L in the past.
    jsConfig.output.file = join(__dirname, "dist/tmp/widgets/com/mendix/widget/custom/PieChart/PieChart.js");
    mJsConfig.output.file = join(__dirname, "dist/tmp/widgets/com/mendix/widget/custom/PieChart/PieChart.mjs");
