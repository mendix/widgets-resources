...
export const RichText = (props: RichTextContainerProps) => {
    const renderCKEditorNode = (): ReactNode => {
        return <CKEditor initData={<p>This is an example CKEditor 4 WYSIWYG editor instance.</p>} />;
    };
    return createElement(
        "div",
        {
            className: props.readOnlyStyle === "text" ? "ck-editor" : undefined,
...
// export class RichText1 extends Component<any> {
