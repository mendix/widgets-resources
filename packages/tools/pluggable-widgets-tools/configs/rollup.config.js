        ...
        result.push({
            ...
            plugins: [
                ...
                styles({
                    ...
                    minimize: production,
                    mode: production && outputFormat === "amd" ? ["extract", `${widgetName}.css`] : "inject",
                    plugins: [postcssUrl({ url: "inline" })],
                    sourceMap: !production ? "inline" : undefined,
                    // Disables original URL resolver in order to use postcss-url library
                    url: false,
                    use: ["sass"]
                }),
                alias({
