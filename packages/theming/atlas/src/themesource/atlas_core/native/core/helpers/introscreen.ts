...
import { IntroScreenType } from "../../types/widgets";
/*
...
export const introScreenLightMode: IntroScreenType = {
    fullscreenContainer: {
...
// Background colors
export const introScreenBackgroundBrandPrimary: IntroScreenType = {
    fullscreenContainer: {
        // All ViewStyle properties are allowed
